...
![Vista de la Static Web App en Azure con la sección Custom domains](/img/evidencias_dominio/01_azure_static_web_app.jpg)
...
![Valores TXT y CNAME generados por Azure](/img/evidencias_dominio/02_obtener_TXT_y_CNAME.jpg)
...
![Configuración de registros DNS en Namecheap](/img/evidencias_dominio/03_namecheap_dominio.jpg)
...
![Panel de dominios personalizados en Azure mostrando validación](/img/evidencias_dominio/04_azure_dominios.jpg)

- Una vez validado, Azure activa HTTPS automáticamente para el dominio personalizado.

![Aplicación accesible desde mambkids.online con HTTPS activo](/img/evidencias_dominio/05_mambkids_online.jpg)
